      ...
      <div className="container">
        <div className="email-newsletter__wrapper">
          ...
          <form className="newsletter-form email-newsletter__form" method="post">
            <input className="newsletter-form__input-text input-text" type="text" name="name" placeholder="Имя" required />
            <input className="newsletter-form__input-text input-text" type="email" name="email" placeholder="E-mail" required />
